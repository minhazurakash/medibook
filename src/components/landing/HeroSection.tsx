import { Search, Calendar, CheckCircle, ArrowRight, Play, Users, Award, Shield } from 'lucide-react';
      ...
      <div className="container relative py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            <div 
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-medium animate-fade-in border border-primary/20"
            >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight animate-slide-up">
              Your Health,{' '}
              <span className="text-transparent bg-clip-text gradient-primary">Our Priority</span>
            </h1>

            <p className="text-lg text-muted-foreground max-w-lg animate-slide-up" style={{ animationDelay: '0.1s' }}>
              Book appointments with verified doctors instantly. Access quality healthcare 
            ...
            >
              ...
              <Button size="lg" className="gap-2 shadow-glow hover:shadow-none transition-all" asChild>
                <Link to={`/doctors${searchQuery ? `?search=${searchQuery}` : ''}`}>
                  Find Doctors
            ...
            <div className="flex flex-wrap gap-3 animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <Button variant="outline" size="sm" className="gap-2 hover:bg-primary/5 hover:border-primary transition-all" asChild>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-4 pt-6 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              {[
          ...
          <div className="relative hidden lg:block">
            ...
            {/* Floating Cards */}
            <div className="absolute -left-8 top-20 glass-card p-4 animate-float shadow-xl">
            ...
            <div className="absolute -right-4 bottom-32 glass-card p-4 animate-float shadow-xl" style={{ animationDelay: '1s' }}>
              <div className="flex items-center gap-3">
            ...
            <div className="absolute right-20 top-8 glass-card p-3 animate-float shadow-lg" style={{ animationDelay: '2s' }}>
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {['bg-primary', 'bg-accent', 'bg-success'].map((bg, i) => (
                    <div key={i} className={`h-8 w-8 rounded-full ${bg} border-2 border-background flex items-center justify-center text-xs text-white font-medium`}>
                      {['JD', 'SM', 'RK'][i]}
                    </div>
                  ))}
                </div>
