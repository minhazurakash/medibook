          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex flex-col items-center lg:items-end space-y-4">
              <div className="glass-card p-8 bg-white/10 backdrop-blur-md border-white/20 w-full max-w-sm">
                <h3 className="text-xl font-semibold text-white mb-4 text-center">Get Started Now</h3>
                <div className="space-y-3">
                  <Button size="lg" variant="secondary" className="w-full gap-2 group" asChild>
                    <Link to="/register">
                      Create Free Account
