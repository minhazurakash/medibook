      ...
      <div className={`p-${compact ? "4" : "6"}`}>
        <div className="flex gap-4">
          ...
          <div className="relative">
            <div
              className={`${compact ? "h-16 w-16" : "h-20 w-20"} rounded-2xl bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center text-primary font-bold text-xl group-hover:scale-105 transition-transform duration-300`}
            >
              {doctor.name
                .split(" ")
                .map((n) => n[0])
        ...
        {!compact && (
          <>
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t">
              ...
              <Button
                asChild
                className="gap-2 group/btn shadow-glow hover:shadow-none transition-all"
              >
        ...
        {compact && (
          <div className="flex items-center justify-between mt-4">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="gap-1 group/btn hover:bg-primary hover:text-primary-foreground transition-all"
            >
              <Link to={`/doctors/${doctor.id}`}>
                View
